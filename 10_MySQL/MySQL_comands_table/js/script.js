...
const data = [
  ...
  },
  {
    ...
    description:
      'Ստեղծում է նշված անունով աղյուսակ(table):Ամեն հատկություն ցանկալի է գրել նոր տողից, որից հետո նշվում է նրա տիպը:  <a href="https://blog.devart.com/mysql-data-types.html">all types</a>',
  ...
  },
  {
    ...
    description:
      'Ընտրում է ընտրված աղյուսակի բոլոր տվյալները(document)։ select կամ/և  from բառը կարելի է գրել և  փոքրատառ և մեծատառ դա չի ազդում ընտրության արդյունքի վրա։ Ընդումված է հիմնականում գրել ՄԵԾԱՏԱՌ',
    example: 'select * from users;',
  },
  {
    id: 7,
    mysql_command:
      'RENAME TABLE <span>&lt;old_name&gt;</span> TO <span>&lt;new_table_name&gt;</span>;',
  ...
  },
  {
    id: 9,
    mysql_command:
      'ALTER TABLE <span>&lt;table_name&gt;</span>\nADD <span>&lt;new_key_name&gt;</span> <span>&lt;type&gt;</span>;',
    description:
      'ALTER(փոփոխել, փոխել) հրամանը թույլ է տալիս անվանափոխել աղյուսակի ցանկացած սյունակի անուն, կամ ավելացնել նորը',
  ...
  },
  {
    ...
    description:
      'Փոխում է սյունակի անունը ԲԱԸՑ ՈՉ ՏԻՊԸ։ Տիպը փոխելու համար պետք է օգտվել առանձին <span>&quot;MODIFY&quot;</span> հրամանից։',
  ...
  },
  {
    ...
    description:
      'Տեղափոխում է սյունակը աղյուսակի մեջ։Այս Օրինակով ազգանունը տեղադրում ենք անունից հետո։ Եթե սյունակը պետք է լինի առաջինը(տես հաջորդ հրամանը) պետք է օգտագործել <span>&quot;FIRST&quot;</span>։',
  ...
  },
  {
    id: 14,
    mysql_command:
      'INSERT INTO <span>&lt;table_name&gt;</span>\nVALUES (value1, value2, value3, ...);',
...
`,
  ...
  },
  {
    id: 15,
    mysql_command:
      'INSERT INTO <span>&lt;table_name&gt;</span> (column1, column2, column3,etc)\nVALUES (...), (...), (...)',
    description:
      'Այս հրամանը միանգամից ավելացնում է մի քանի տվյալներ աղյուղակի մեջ։ Տվյալների արժեքների հերթականությունը պետք է համընկնի սյուների հերթականության հետ։Եթե որևիցե տվյալ նշված սյունակների համար չփոխանցվի ապա կհարուցվի սխալ, իսկ հակառակ դեպքում այն կլինի <span>&quot;NULL&quot;</span>, կամ եթե կա DEFAULT արժեք սյունակի համար կվերցրվի այդ արժեքը։(տես 26-րդ հրամանը)',
    example: "INSERT INTO dogs (id, name, gender)\nVALUES (1, 'AXEL', NULL),\n(1, 'AXEL', 'male');",
  },
  {
    id: 16,
    mysql_command:
      'SELECT <span>&lt;column_name_1&gt;</span>, <span>&lt;column_name_2&gt;</span>;...',
    description:
      "Ընտրում է աղյուսակի մեջի <span>ԲՈԼՈՐ</span> տվյալներից միայն նշված սյունակները, որոնց քանակը կարող է լինել մեկ կամ 'n' հատ։",
    example: 'SELECT name, surname\nFROM persons;',
  },
  {
    id: 17,
    mysql_command:
      'SELECT * FROM <span>&lt;table&gt;</span>\nWHERE<span>&lt;column_name&gt;</span> = 1',
    description:
      'Ընտրում  է <span>&lt;persons&gt;</span> table-ից միայն 1 id-ով դոկումենտը։ Եթե նման id-ով դոկումենտ չլինի կվերադարձնի <span>&quot;NULL&quot;</span>: Իսկ սխալ սյաունակի ասնւնը կհարուցի <span>&quot;Error Code 1064&quot;</span> սխալը։',
    example:
  ...
  },
  {
    ...
    description:
      'Թարմացնում է table-ի մեջ <span>&quot;SET&quot;</span> հրամանի միջոցով ընտրված սյունակի արժեքը(salary) ԲՈԼՈՐ դոկումենտների համար նշանակելով նույնը:',
  ...
  },
  {
    ...
    `,
    description:
      "Ջնջում է table-ի մեջ ՄԻԱՅՆ <span>&quot;WHERE&quot;</span> հրամանի միջոցով ընտրված դոկումենտը։ Վերջին տողը կջնջի 14 id-ից բարձր id ունեցող 'user'-րին: Միայն առաջին տողը եթե գրենք այն կջնջի բոլոր տվյալները աղյուսակի մեջից, բայց ոչ աղյուսակը։",
  ...
  },
  {
    ...
    description:
      '<span>&quot;UNIQUE&quot;</span> հրամանի միջոցով նշված սյունակը հետագայումչի կարող կրկնվել, իսկ <span>&quot;NOT NULL&quot;</span> հրամանի միջոցով նշված սյունակը հետագայում չի կարող նշանակվել դատարկ կամ NULL։<span>&quot;DEFAULT&quot;</span> հրամանը նշանակում է համապատասխան դեֆոլտ արժեք եթե ավելացման պահին այն բաց թողնվի։',
  ...
  },
  {
    ...
    description:
      'Այս գրվածքը թույլ է տալիս արդեն ստեղծված աղյուսակի մեջ ինչ որ դաշտ նշանակենք <span>&quot;NOT NULL&quot;</span>։',
    example: 'CREATE TABLE persons (\nperson_id INT UNIQUE, \nname VARCHAR(50) NOT NULL\n);',
  },
  {
    id: 23,
    ...
    description:
      'Այս գրվածքը թույլ է տալիս անմիջապես աղյուսակի ստեղծման պահին տալ վալիդացիա կոնկրետ դաշտի համար։<span>&quot;CHECK&quot;</span> բանալի բառի միջոցով Օրինակում նշանակվում է տարիքի ներքին սահման։',
  ...
  },
  {
    ...
    description:
      'Այս գրվածքը թույլ է տալիս արդեն առկա  աղյուսակի մեջ նշանակել  վալիդացիա կոնկրետ դաշտի համար։',
  ...
  },
  {
    ...
    description:
      'Այս գրվածքը թույլ է տալիս արդեն ստեղծված աղյուսակի մեջ ինչ որ դաշտին  նշանակել <span>&quot;DEFAULT&quot;</span> արժեք։',
    example: 'ALTER TABLE persons\n ALTER price SET DEFAULT 0;',
  },
  {
    id: 27,
    mysql_command:
      'CREATE TABLE <span>&lt;table_name&gt;</span> (\n key type <span>PRIMARY KEY</span> AUTO INCREMENT\n);',
    description:
      "<span>&quot;PRIMARY KEY&quot;</span> (UNIQUE + NOT NULL)։ Ամեն մի աղյուսակի մեջ կարող է լինել միայն ՄԵԿ 'PRIMARY KEY' դաշտ։Երկրորդ նման փորձը կհարուցի սխալ(1068 Multiply primary key defined):Իսկ <span>&quot;AUTO INCREMENT&quot;</span> թույլ է տալիս մեզ ստեղծելու պահին այլևս չնշել այդ դաշտի արժեքտ, այն ավտոմատ կերպով ավելանում է։",
    example:
  ...
  },
  {
    id: 28,
    mysql_command:
      'ALTER TABLE <span>&lt;t_name&gt;</span>\nADD CONSTRAINT\nPRIMARY KEY(<span>&lt;old_column_name&gt;</span>);',
    description:
      '<span>&quot;PRIMARY KEY&quot;</span> (UNIQUE + NOT NULL) դաշտ է նշանակում է արդեն ստեղծված աղյուսակի մեջ։',
    example: `ALTER TABLE users 
    ADD CONSTRAINT
    PRIMARY KEY(user_id);`,
  },
  {
    ...
    description:
      'Փոխում է աղյուսակում ավտոմատի ինկրեմենտացիայի նախնական շեմը։ Առաջին ավելացված դոկումենտը կլինի "777" id-ով։ ',
    example: `ALTER TABLE users 
    AUTO_INCREMENT = 777;`,
  },
  {
    id: 30,
    mysql_command:
      'CREATE TABLE <span>&lt;t_name&gt;</span>\nFOREIGN KEY("column_name")\n<span>REFERENCES</span> <span>&lt;t_name&gt;</span>("column_name");',
    description:
      'Ստեղծելով <span>&quot;books&quot;</span> table-ը միանգամից <span>&quot;FOREIGN KEY&quot;</span> միջոցով մեկ դաշտի արժեքը հղվում է այդ նույն DB-ում առկա մեկ այլ(users) table-ին։Դրանով իսկ կապ է ստեղծվում այդ 2 աղյուսակների մեջև, որը կարելի է օգտագործել որոնումների ժամանակ։',
  ...
  },
  {
    id: 31,
    mysql_command:
      'SELECT <span>SUM("column_name")</span> AS total_sum\nFROM <span>&lt;t_name&gt;</span>;',
    description:
      'Փոխում է աղյուսակում ավտոմատի ինկրեմենտացիայի նախնական շեմը։ Առաջին ավելացված դոկումենտը կլինի "777" id-ով։ ',
  ...
  },
  {
    id: 32,
    mysql_command:
      'SELECT <span>SUM("column_name")</span> AS total_sum FROM <span>&lt;t_name&gt;</span>;',
  ...
  },
  {
    id: 33,
    mysql_command:
      'SELECT <span>MAX("column_name")</span> AS total_sum FROM <span>&lt;t_name&gt;</span>;',
    description:
      'Միանգամից գտնում է նշված սյունակի max արժեքը։ <span>MIN</span>-ը համապատասխան ձևով կվերադարձնի մինիմում արժեքը։<span>AVG</span>-ն(average-միջին) կվերադարձնի գնի միջին թվաբանականը։ ',
  ...
  },
  {
    ...
    FROM <span>&lt;t_name&gt;</span>;`,
    description:
      '<span>CONCAT</span> ֆունկցիան պետք է սյունակների միավորման համար։Վերադարջված արժեքը կլինի ֆունկցիայի մեջ նշված սյունակների արժեքները մեկ "n" սյունակ անվան տակ։ Օրինակում միավորվում է անուն ազգանունը ',
